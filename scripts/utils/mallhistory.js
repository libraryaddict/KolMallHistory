...
MallRecords = /*#__PURE__*/function () {
  ...
  function MallRecords(jsonObject) {_classCallCheck(this, MallRecords);_defineProperty(this, "records", []);_defineProperty(this, "lastUpdated", 0);
    ...
    function getRecords(days) {
      var cutoff = this.lastUpdated - days * 60 * 60 * 24;

      return this.records.filter((r) => r.date >= cutoff);
    } }]);return MallRecords;}();var


MallAge;(function (MallAge) {MallAge[MallAge["HOURS_12"] = 5] = "HOURS_12";MallAge[MallAge["DAY"] = 1] = "DAY";MallAge[MallAge["WEEK"] = 2] = "WEEK";MallAge[MallAge["MONTH"] = 3] = "MONTH";MallAge[MallAge["ALL"] = 4] = "ALL";MallAge[MallAge["HOURS_48"] = 6] = "HOURS_48";MallAge[MallAge["WEEKS_2"] = 7] = "WEEKS_2";})(MallAge || (MallAge = {}));var
...
var MallHistory = /*#__PURE__*/function () {
  ...
  function MallHistory() {_classCallCheck(this, MallHistory);_defineProperty(this, "items", new Map());
    ...
    function ensureUpToDate(item, daysToCheck) {
